...
@Entity
@NamedQueries({
        @NamedQuery(name = Operator.SELECT_ALL, query = Operator.SELECT_ALL_OPERATORS_SQL_QUERY),
        @NamedQuery(name = Operator.SELECT_ALL_DIAMOND_BUSES_ROUTES, query = Operator.SELECT_DIAMOND_BUS_ROUTES_SQL_QUERY),
        @NamedQuery(name = Operator.SELECT_ALL_PARK_GATES_OPERATORS, query = Operator.SELECT_PARK_GATES_SQL_QUERY)
...
public class Operator {
     ...
     */
    public static final String SELECT_PARK_GATES_SQL_QUERY = "select o from Operator o join o.routes r where r.startStop.description='Park Gates' or r.destinationStop.description='Park Gates'";

    /**
     * The HQL Query for the 'select all routes operated by diamond buses' query.
     */
    public static final String SELECT_DIAMOND_BUS_ROUTES_SQL_QUERY = "select r from Route r join r.operators o where o.name='Diamond Buses'";

    /**
     * The HQL Query for the select all operators query.
     */
    public static final String SELECT_ALL_OPERATORS_SQL_QUERY = "select o from Operator o order by o.name asc";
